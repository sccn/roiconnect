function [conn, nlags] = data2spwctrgc(data, fres, nlags, cond, nboot, maxfreq, output)
...
% neuroscience methods, 223, 50-68.
  ...
  clear TRGC GC TRPDC PDC TRDTF DTF CS
  ...
  if nboot < 2 % no bootstrap
    ...
    if ~isempty(intersect(output, {'TRGC', 'GC', 'TRPDC', 'PDC', 'TRDTF', 'DTF'}))
      ...
      % (time-reversed) GC conditioned on all other variables
        ...
        if ~isempty(intersect(output, {'TRGC', 'GC'}))
          ...
          for ii = 1:nchan
            for jj = (ii+1):nchan
              iind = iind + 1;
              disp(['testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(ii) '] -> [' num2str(jj) '], conditional'])
              ...
              iind = iind + 1;
              disp(['testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(jj) '] -> [' num2str(ii) '], conditional'])
      ...
      % (time-reversed) GC just between sender and receiver 
        ...
        for ii = 1:nchan
          for jj = (ii+1):nchan
            iind = iind + 1;
            disp(['testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(ii) '] -> [' num2str(jj) ']'])
            ...
            if ~isempty(intersect(output, {'TRGC', 'GC'}))
              ...
              iind = iind + 1;
              disp(['testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(jj) '] -> [' num2str(ii) ']'])
    ...
    for iboot = 1:nboot
      ...
      if ~isempty(intersect(output, {'CS'}))
        disp(['bootstrap run ' num2str(iboot) '/' num2str(nboot) ', computing cross-spectrum'])

        CS_ = permute(tsdata_to_cpsd(data(:, :, bootinds), fres, 'MT'), [3, 1, 2]);
        ...
        % (time-reversed) GC conditioned on all other variables
          ...
          if ~isempty(intersect(output, {'TRGC', 'GC'}))
            ...
            for ii = 1:nchan
              for jj = (ii+1):nchan
                iind = iind + 1;
                disp(['bootstrap run ' num2str(iboot) '/' num2str(nboot) ', testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(ii) '] -> [' num2str(jj) '], conditional'])
                ...
                iind = iind + 1;
                disp(['bootstrap run ' num2str(iboot) '/' num2str(nboot) ', testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(jj) '] -> [' num2str(ii) '], conditional'])
        ...
        % (time-reversed) GC just between sender and receiver 
          ...
          for ii = 1:nchan
            for jj = (ii+1):nchan
              ...
              disp(['bootstrap run ' num2str(iboot) '/' num2str(nboot) ', testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(ii) '] -> [' num2str(jj) ']'])
              ...
              if ~isempty(intersect(output, {'TRGC', 'GC'}))
                ...
                iind = iind + 1;
                disp(['bootstrap run ' num2str(iboot) '/' num2str(nboot) ', testing connection ' num2str(iind) '/' num2str(ninds) ': [' num2str(jj) '] -> [' num2str(ii) ']'])

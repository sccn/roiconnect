...
EEG = pop_dipfit_settings( EEG, 'hdmfile',fullfile(eeglabp, 'plugins/dipfit/standard_BEM/standard_vol.mat'),'coordformat','MNI',...
    'mrifile',fullfile(eeglabp, 'plugins/dipfit/standard_BEM/standard_mri.mat'),...
    'chanfile',fullfile(eeglabp, 'plugins/dipfit/standard_BEM/elec/standard_1005.elc'),'coord_transform',[0 0 0 0 0 -1.5708 1 1 1] ,'chansel',[1:EEG.nbchan] );
...
%% Simulate VAR model 2 sources coupled

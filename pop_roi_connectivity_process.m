...
if nargin < 2
    ...
    roi(3).label = 'ROI: AFNI TTatlas+tlrc (Fieldtrip)';
    roi(3).file  = fullfile(p, 'template','atlas','afni','TTatlas+tlrc.HEAD');
    roi(3).align = [ ];
    roi(3).enable = 'off';
    roi(3).scale  = 4;
    roi(3).atlasliststr = { '' };
    ...
    cb_select2 = [ 'usrdata = get(gcf, ''userdata'');' ...
                  'usrdat = usrdata{2}(get(findobj(gcf, ''tag'', ''selection2''), ''value''));' ...
                  ...
                  'usrdata{3} = usrdat.scale;' ...
                  'set(gcf, ''userdata'', usrdata);' ...
                  'clear usrdat usrdata;' ];
    ...
    cb_selectcoreg2 = [ 'plot3dmeshalign(get( findobj(gcbf, ''tag'', ''strfile1''), ''string''), ' ...
                                        'get( findobj(gcbf, ''tag'', ''strfile2''), ''string''), ' ...
                                        'str2num(get( findobj(gcbf, ''tag'', ''transform2''), ''string'')));' ];
